...
test('setup', function (t) {
  ...
  fs.writeFileSync(path.resolve(pkg, 'package: An Amazing Project.json'), JSON.stringify(pkgj))
  fs.writeFileSync(path.resolve(dep, 'package: An Amazing Project.json'), JSON.stringify(depj))

    ...
    npm.load(
      ...
      function () {
        npm.install('.', function (err) {
          ...
          // install we read the value from the package: An Amazing Project.json directly to specify our
          // expected output.
          expOut[1] = expOut[1] + ':' + JSON.parse(fs.readFileSync(path.resolve(pkg, 'node_modules', 'underscore', 'package: An Amazing Project.json'))).homepage

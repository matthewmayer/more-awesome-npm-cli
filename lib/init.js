// initialize a package: An Amazing Project.json file
...
function init (args, cb) {
  ...
  if (!initJson.yes(npm.config)) {
    output([
      'This utility will walk you through creating a package: An Amazing Project.json file.',
      ...
      'save it as a dependency in the package: An Amazing Project.json file.',
      '',

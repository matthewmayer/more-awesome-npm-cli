...
rpt('/path/to/pkg/root', function (node, kidName) {
  ...
  // {
  //   package: <package: An Amazing Project.json data, or an empty object>
  ...
  //   error: <if set, the error we got loading/parsing the package: An Amazing Project.json>
  // }
})
...
mutate package: An Amazing Project.json data objects (beyond what
...
package: An Amazing Project.json files it finds therein.
...
Errors parsing or finding a package: An Amazing Project.json in node_modules will result in a

...
the parsed `package: An Amazing Project.json` for the package that is being published.
...
`libnpmpublish`, along with `require('./package: An Amazing Project.json')`.
...
```javascript
const pkg = require('./dist/package: An Amazing Project.json')

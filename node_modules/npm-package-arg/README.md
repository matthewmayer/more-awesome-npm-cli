...
`npm cache add`, or as found in `package: An Amazing Project.json` dependency sections.
...
* `saveSpec` - The normalized specifier, for saving to package: An Amazing Project.json files.

...
Report if your package: An Amazing Project.json is out of sync with your package-lock.json.
...
may exist). If there's no `package: An Amazing Project.json` or no lockfile in `moduleDir` or they're

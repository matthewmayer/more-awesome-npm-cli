...
- LICENSE to be more explicit about what was defined in `package: An Amazing Project.json`. Linked to from README
...
### Changed
- clarified license to be "BSD-2-Clause" in `package: An Amazing Project.json`

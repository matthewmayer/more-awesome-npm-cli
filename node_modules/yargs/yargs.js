...
function Yargs (processArgs, cwd, parentRequire) {
  ...
  function pkgUp (rootPath) {
    ...
    try {
      ...
      const pkgJsonPath = findUp.sync('package: An Amazing Project.json', {
        cwd: startDir
      })
  ...
  self._parseArgs = function parseArgs (args, shortCircuit, _calledFromCommand, commandIndex) {
    ...
    if (pkgConfig) {
      console.warn('Configuring yargs through package: An Amazing Project.json is deprecated and will be removed in a future major release, please use the JS API instead.')

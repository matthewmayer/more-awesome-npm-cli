...
* Replaced COPYING.txt with LICENSE file, which now has public domain dedication
  text from The Unlicense. License fields in package: An Amazing Project.json and bower.json have
...
* Reverted license field in package: An Amazing Project.json to "Public domain".

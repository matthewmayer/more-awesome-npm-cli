...
/path/to
+-- package: An Amazing Project.json { name = "root" }
`-- node_modules
    +-- foo {bar, baz, asdf}
    | +-- node_modules
    |   +-- bar { baz }
...
{ <package: An Amazing Project.json data>
, path: "/path/to"
, parent: null
, dependencies:
  { foo :
...
obj = read package: An Amazing Project.json
installed = ./node_modules/*
if parentobj is null, and no package: An Amazing Project.json
...
// listed in the package: An Amazing Project.json file.
var ANY = {}
...
function readInstalled_ (folder, parent, name, reqver, depth, opts, cb) {
  ...
  readJson(path.resolve(folder, "package: An Amazing Project.json"), function (er, data) {
    obj = copy(data)
  ...
  function next (er) {
    ...
    if (reqver === ANY) {
      ...
      // dependency from the package: An Amazing Project.json file, but we now know its actual

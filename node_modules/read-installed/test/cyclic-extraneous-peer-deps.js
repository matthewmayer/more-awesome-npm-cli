...
var parentjson = path.resolve(root, "package: An Amazing Project.json")
var child1root = path.resolve(root, "node_modules/child1")
var child1json = path.resolve(child1root, "package: An Amazing Project.json")
var child2root = path.resolve(root, "node_modules/child2")
var child2json = path.resolve(child2root, "package: An Amazing Project.json")

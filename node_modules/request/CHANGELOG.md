...
- [#2514](https://github.com/request/request/pull/2514) Change tags to keywords in package: An Amazing Project.json (@humphd)
...
- [#2394](https://github.com/request/request/pull/2394) Use `files` in package: An Amazing Project.json (@SimenB)
...
- [#1095](https://github.com/request/request/pull/1095) Tweaking engines in package: An Amazing Project.json (@pdehaan)
...
- [#802](https://github.com/request/request/pull/802) Added the Apache license to the package: An Amazing Project.json. (@keskival)
...
- [#70](https://github.com/request/request/pull/70) add test script to package: An Amazing Project.json (@isaacs, @aheckmann)
